...
<body>
    ...
    <div class="down">
        <div class="p1">
            <h1><center><b>Welcome to Wonder<br>To Do</b></center></h1>
        </div>
        <div class="header1">
        ...
        <div class="container">
            <div class="image-container">
                <img id="myImg" src="https://as2.ftcdn.net/v2/jpg/01/39/06/21/1000_F_139062107_09UuoSUkJfkl6VqxGR0225mU2pyGepqU.jpg" alt="room" >  
            </div>
            <table class="tab1">
                <tr>
                    <td>
